...
public class MapSheetDecorator
{
    ...
    public MarkDecorator marksDecorator;
    public StraightLineDecorator straightLinesDecorator;
    public CurvedLineDecorator curvedLineDecorator;
    public AreasDecorator areasDecorator;
    public OuterImageDecorator outerimgs;
    public MapObjectBaseClass[] Creators => new MapObjectBaseClass[]
    {marksDecorator, straightLinesDecorator, areasDecorator, curvedLineDecorator, outerimgs};

    public MapSheetDecorator(MapSheet SheetData)
    {
        DataReference = SheetData;
        ObjectsInList = new List<MapObjectDecorator>();
        marksDecorator = new MarkDecorator();
        straightLinesDecorator = new StraightLineDecorator();
        areasDecorator = new AreasDecorator();
        curvedLineDecorator= new CurvedLineDecorator();
        outerimgs = new OuterImageDecorator();
    }
